...
public final class CommandBuffers {
    ...
    public void recordOffscreen(float[] bgColor,
                                long renderPass,
                                long framebuffer,
                                long pipelineHandle,
                                long pipelineLayoutHandle,
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            try (MemoryStack barrierStack = MemoryStack.stackPush()) {
                VkImageMemoryBarrier.Buffer srcBarrier = VkImageMemoryBarrier.calloc(1, barrierStack)
            ...
            try (MemoryStack barrierStack = MemoryStack.stackPush()) {
                VkImageMemoryBarrier.Buffer dstBarrier = VkImageMemoryBarrier.calloc(1, barrierStack)
                        .sType(VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER)
            ...
            blit.get(0)
                    .srcOffsets(1).set(width, height, 1);
            blit.get(0)
                    .srcSubresource(s -> s
                            .aspectMask(VK_IMAGE_ASPECT_COLOR_BIT)
                            .mipLevel(0)
            ...
            blit.get(0)
                    .dstOffsets(1).set(swapchainWidth, swapchainHeight, 1);
            blit.get(0)
                    .dstSubresource(s -> s
                            .aspectMask(VK_IMAGE_ASPECT_COLOR_BIT)
                            .mipLevel(0)
            ...
            try (MemoryStack barrierStack = MemoryStack.stackPush()) {
                VkImageMemoryBarrier.Buffer presentBarrier = VkImageMemoryBarrier.calloc(1, barrierStack)
                        .sType(VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER)
